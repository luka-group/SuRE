...
def parse_args():
    ...
    parser.add_argument(
        "--type_file", type=str, default=None, help="A csv or a json file containing the type data."
    )
    parser.add_argument(
    ...
    parser.add_argument("--use_label_smoother", action="store_true", help="Whether or not to push the model to the Hub.")
...
def main():
    ...
    print(tokenizer(["@", "*", "^", "#", "<e1>", "<e1-TITLE>", "</e2-ORGANIZATION>"]))
    ...
    for epoch in range(args.num_train_epochs):
        ...
        for each in tqdm(eval_data):
            ...
            inputs = tokenizer.batch_encode_plus([sentence], return_tensors="pt",
                max_length=256, padding='max_length', truncation=True).to(model.device)
            ...
            if na_score > p_score[1]:
                ...
                preds.append(relation_map[p_score[0]])
